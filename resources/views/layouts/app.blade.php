      ...
      <header>
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
          ...
          <nav class="my-2 my-md-0 mr-md-3">
              ...
              <a class="text-dark ml-1 mr-1" href="{{ route('blogger-cabinet-articles') }}">"Мои статьи</a>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" style="text-align: center;font-size: 15px;font-weight: bold;">
                            @foreach( $categories as $category)
                                <div class="col-6"><a href="{{ route('categories.show',$category) }}">{{ $category->name}}</a></div>
                            @endforeach
                        </div>
                    </div>
                </div>
